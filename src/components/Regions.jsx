...
const Regions = () => {
  return (
    <div name="regions" className="w-full md:h-screen bg-blue-900 py-24">
      ...
      <div class="p-[100px] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        <div class="rounded-md overflow-hidden shadow-lg drop-shadow-sm bg-blue-400 opacity-90">
          <img
            class="w-full"
